...
pub enum Operation {
    ...
    AddFixedVersion { version: String },
    RemoveFixedVersion { version: String },
    AddAffectedVersion { version: String },
    RemoveAffectedVersion { version: String },
...
impl Operation {
    ...
    pub fn tag(&self) -> &'static str {
        match self {
            ...
            Operation::AddFixedVersion { .. } => "AddFixedVersion",
            Operation::RemoveFixedVersion { .. } => "RemoveFixedVersion",
            Operation::AddAffectedVersion { .. } => "AddAffectedVersion",
            Operation::RemoveAffectedVersion { .. } => "RemoveAffectedVersion",
